...
# для установки необходимо в файл requirements.txt добавить строки
# 'PyTelegramBotApi'
# 'faker'
...
bot = TeleBot(token='5718094396:AAFHepkUQarMRGGppPQQ-CUWMAO7Vmuk-h0', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет, {0.first_name}! Я смогу сгенерировать номер тестовой банковской карты для тебя\nВыбери тип карты:'.format(message.from_user,bot.get_me()), # текст сообщения
        parse_mode='html',
